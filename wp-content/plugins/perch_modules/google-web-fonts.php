<?php
//add_action( 'init', 'perch_modules_google_fonts_init' );
function perch_modules_google_fonts_init(){
    $google_fonts_cache_key = 'perch_modules_google_fonts';
   
    $google_fonts_data = json_decode( trim( perch_modules_get_google_fonts_array() ), true );
    ...
    if ( is_array( $google_fonts_data ) && isset( $google_fonts_data['items'] ) ) {
      ...
      set_theme_mod( 'perch_modules_google_fonts', $google_fonts );
...
function perch_modules_get_google_fonts_array(){
$perch_modules_fonts ='{
  ...
  "items": [
...

    {
      ...
      "files": {
        ...
        "300": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU2vwrj5.ttf",

        "500": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU33w7j5.ttf",

        "600": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU3bxLj5.ttf",

        "700": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU2_xbj5.ttf",

        "800": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU2jxrj5.ttf",

        "900": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GRYax7VC4qNB4nYpBdaKU2Hx7j5.ttf",

        "regular": "http://fonts.gstatic.com/s/inknutantiqua/v3/Y4GSYax7VC4qNB4nYpBdaKXUD.ttf"
