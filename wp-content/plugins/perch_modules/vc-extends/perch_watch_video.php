...
// Element Class 
class PerchWatchVideo extends PerchVcMap {
     
    private $base = 'perch_watch_video';

    private $title = 'Modal popup';
    ...
    function __construct() {
        ...
        // Shortcode filter
        add_filter( $this->base, array( $this, 'perch_watch_video_output' ), 30, 2 ); 
        add_filter( $this->base.'_slide', array( $this, 'perch_watch_video_slide_output' ), 30, 2 ); 
    }
    ...
    // Element HTML
    public function perch_watch_video_output( $atts, $content = NULL ) {
        ...
        <div '. implode( ' ', $wrapper_attributes ).'>            
            ...
            <a class="video-popup2" href="'.esc_url($url).'">
        ...
        $html = apply_filters('perch_modules/watch_video/output', $html, $html_args, $atts);
    ...
    public function perch_watch_video_slide_output( $atts, $content = NULL ) {
        ...
        $html .= self::perch_watch_video_output($atts);
        $html .='</div>';
