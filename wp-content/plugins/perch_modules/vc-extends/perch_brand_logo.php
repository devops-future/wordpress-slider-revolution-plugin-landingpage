...
// Element Class 
class PerchBrandLogo extends PerchVcMap {
     
    private $base = 'perch_brand_logo';

    private $title = 'Brand logo';
    ...
    private function vc_map_args(){        
        ...
        $array = PerchVcMapImage::image_args_simple();        
    ...
    public function perch_image_output( $atts, $content = NULL ) {
        ...
        extract($atts);
        $html = PerchVcMapImage::image_html($atts);  
        ...
        $html = apply_filters('perch_modules/brand_logo/output', $html, $html_args, $atts);    
    ...
    public function vc_mapping( $return = false ) {
       ...
       $vc_map = array(
                ...
                'base' => $this->base,
                'name' => $this->title,                
                'description' => __('Display brand logo', 'perch'),                 
                'params' => $params,
