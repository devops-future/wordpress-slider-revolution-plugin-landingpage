...
// Element Class 
class PerchPressLogo extends PerchVcMap {
     
    private $base = 'perch_press_logo';

    private $title = 'Press logo';
    ...
    public function perch_image_output( $atts, $content = NULL ) {
        ...
        $html = apply_filters('perch_modules/press_logo/output', $html, $html_args, $atts);
