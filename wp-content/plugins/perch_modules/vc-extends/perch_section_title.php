...
/*
Element Description: VC Section title
*/
 
// Element Class 
class PerchSectionTitle extends PerchVcMap {
     
    private $base = 'perch_section_title';

    private $title = 'Section title';
    ...
    function __construct() {
        ...
        // Shortcode filter
        add_filter( $this->base, array( $this, 'perch_section_title_output' ), 30, 2 ); 
        add_filter( $this->base.'_slide', array( $this, 'perch_section_title_slide_output' ), 30, 2 ); 
    }
    ...
    // Element HTML
    public function perch_section_title_output( $atts, $content = NULL ) {
        ...
        $html = apply_filters('perch_modules/section_title/output', $html, $html_args, $atts); 
    ...
    public function perch_section_title_slide_output( $atts, $content = NULL ) {
        ...
        $html .= self::perch_section_title_output($atts);
        $html .='</div>';
