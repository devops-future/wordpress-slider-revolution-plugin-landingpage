...
// Element Class 
class PerchHeroText extends PerchVcMap {
     
    private $base = 'perch_hero_text';

    private $title = 'Hero text';
    ...
    function __construct() {
        ...
        // Shortcode filter
        add_filter( $this->base, array( $this, 'perch_hero_text_output' ), 30, 2 ); 
        add_filter( $this->base.'_slide', array( $this, 'perch_hero_text_slide_output' ), 30, 2 ); 
    }
    ...
    private function vc_map_args(){        
        ...
        $array = array_merge($array, self::enable_newsletter_form() );
    ...
    // Element HTML
    public function perch_hero_text_output( $atts, $content = NULL ) {
        ...
        $content_html = self::content_html($atts, $content);
        $content_list_html = self::content_list_html($atts);
        $newsletter_form_html = self::newsletter_form_html($atts);
        ...
        $html_args = array(
            ...
            'newsletter_form_html' => $newsletter_form_html,         
        ...
        $html = apply_filters('perch_modules/hero_text/output', $html, $html_args, $atts);
    ...
    public function perch_hero_text_slide_output( $atts, $content = NULL ) {
        ...
        $html .= self::perch_hero_text_output($atts);
        $html .='</div>';
